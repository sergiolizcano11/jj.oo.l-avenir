...
<body>
    ...
    <section id="view-oscars" class="view">
        ...
        <p class="text-center small text-secondary mb-4">1 vote unique par catégorie</p>
    ...
    <script>
        ...
        const app = {
            ...
            validate: () => {
                ...
                if(inp === m.code) {
                    m.completed = true; fb.innerText = "Validé !"; fb.style.color = "#28a745"; confetti();
